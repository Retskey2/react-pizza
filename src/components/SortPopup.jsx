...
const SortPopup = React.memo(function SortPopup({items, activeSortItem, onClickSort}) {
    ...
    //Самый первый рендер и отлавливание клика
    ...
    return (
        <div
            ref={sortRef} //получаем ссылку на этот DOM
            className="sort">
            ...
            {
                visiblePopup && //Если истина, то выполнится, ложь - нет
                <div className="sort__popup">
                    <ul>
                        {items &&
                        items.map((obj, index) =>
                            <li className={activeSortItem === obj.type ? 'active' : ''}
